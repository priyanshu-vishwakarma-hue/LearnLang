        ...
        <div className="flex items-center justify-between h-14 sm:h-16 md:h-18">
          ...
          <div className="hidden md:flex items-center gap-2 lg:gap-3">
              ...
              <button
                ...
                style={{
                  background: isActive(item.path)
                    ? darkMode ? item.color : `${item.color}20`
                    : darkMode ? '#565869' : '#f3f4f6',
                  color: isActive(item.path)
                    ? '#ffffff'
                    : darkMode ? '#ececf1' : '#374151'
                }}
              >
                <item.icon size={18} />
            ...
            <button
              ...
              className="p-2 lg:p-2.5 rounded-lg transition-all hover:opacity-80"
              style={{
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 lg:px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg font-semibold text-sm lg:text-base transition-all"
            >
              <LogOut size={18} />
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="space-y-2">
              ...
              <button
                onClick={handleLogout}
                className="w-full flex items-center gap-3 px-4 py-3 bg-red-500 hover:bg-red-600 text-white rounded-lg font-semibold text-sm transition-all"
              >
                <LogOut size={20} />
                <span>Logout</span>
              </button>
